Rails.application.routes.draw do
  ...
  post 'play/edit-chef', to: 'play#edit_chef', as: "chef_editted"
  get 'play/create-chef', to: 'play#create_chef', as: "chef_create_form"
  post 'play/create-chef', to: 'play#chef_created', as: "chef_created"
  get '/play/pick-ingredients', to: 'play#pick_ingredients', as: "ingredient_selection_form"
  post '/play/pick-ingredients', to: 'play#ingredients_picked', as: "ingredients_selected"
